...
const items=[['Dashboard','/',DashboardRounded],['Customers','/customers',GroupsRounded],['Customer Configuration','/customer-configuration',GroupsRounded],['Internal Transfers','/internal-transfers',AccountBalanceRounded],['Pricing','/pricing',PriceChangeRounded],['Pricing Editor','/pricing-editor',PriceChangeRounded],['Approval Queue','/approval-queue',PriceChangeRounded],['Pricing Versions','/pricing-versions',PriceChangeRounded],['Pricing Overrides','/pricing-overrides',PriceChangeRounded],['Billing Accounts','/billing-accounts',AccountBalanceRounded],['Products','/products',Inventory2Rounded],['Invoices','/invoices',ReceiptLongRounded],['Reports','/reports',AssessmentRounded],['Administration','/admin',AdminPanelSettingsRounded],['Settings','/settings',SettingsRounded]] as const;
